    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.container}>
        ...
        >
          ...
          >
            <Svg width={40} height={40} fill={color.white} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
          ...
          <TouchableOpacity 
            style={styles.home}
            onPress={() => {
              navigation.navigate("Marathon")
            }}  
          >
            <Svg width={40} height={40}  fill={color.white} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
            ...
            <Text style={styles.label}>마라톤</Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity 
            ...
            <Text style={styles.label}>챌린지</Text>
          </TouchableOpacity>
        </LinearGradient>
      </View>
    </SafeAreaView>
